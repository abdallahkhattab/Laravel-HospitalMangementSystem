    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                ...
                <span class="text-muted mt-1 tx-13 mr-2 mb-0">/ {{ trans('Dashboard/Doctors.edit_doctor') }}</span>
            </div>
        </div>
    </div>
@endsection
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('doctors.update', $doctor) }}" method="POST" autocomplete="off" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control @error('name') is-invalid @enderror" 
                                           ...
                                           id="name" 
                                           type="text" 
                                           value="{{ old('name', $doctor->translateOrNew(app()->getLocale())->name) }}">
                                    @error('name')
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select name="section_id" 
                                            id="section_id" 
                                            class="form-control SelectBox @error('section_id') is-invalid @enderror">
                                        <option value="" disabled>{{ trans('Dashboard/Doctors.select_section') }}</option>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select name="status" 
                                        ...
                                        <option value="1" {{ old('status', $doctor->status) == '1' ? 'selected' : '' }}>
                                            {{ trans('Dashboard/Doctors.enabled') }}
                                        </option>
                                        <option value="0" {{ old('status', $doctor->status) == '0' ? 'selected' : '' }}>
