...
@endsection
@section('content')
@include('Dashboard.alerts.messages_alert')
				<!-- row -->
                    <!-- row opened -->
                                    ...
                                    <div class="table-responsive">
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($laboratorie_employees as $laboratorie_employee)
                                               ...
                                               @include('Dashboard.Manage_LaboratorieeEmployee.edit')
                                               @include('Dashboard.Manage_LaboratorieeEmployee.delete')
                    ...
                    @include('Dashboard.Manage_LaboratorieeEmployee.add')
                    <!-- /row -->
